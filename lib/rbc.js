...
RBCBridge.loadParameters("device", ["model", "platform", "uuid", "version", "name", "type"], function (parameters) {
    device.model      = parameters.device.model;
    device.platform   = parameters.device.platform;
    device.guid       = parameters.device.uuid;
    device.osVersion  = parameters.device.version;
...
{
    /*
     Android options: {senderID: string}
     iOS options: {
     badge:boolean,
     sound:boolean,
     alert:boolean
     ...
     WP options: {
     mpnsChannelName:string,
     mpnsServiceName:string,
     tileAllowedDomains:string[]
     }
     */

    register: function ( options, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("pushNotifications", "register", [ "options", "successCallback", "failedCallback" ], arguments);
    },
    ...
    unregister: function ( options, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("pushNotifications", "unregister", [ "options", "successCallback", "failedCallback" ], arguments);
    },

    setApplicationIconBadgeNumber: function ( badge, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("pushNotifications", "setApplicationIconBadgeNumber", ["badge", "successCallback", "failedCallback"], arguments);
    }
}
...
window.btPeripheral =
{
    ...
    {
        return RBCBridge.execWithArguments("btPeripheral", "start", [ "successCallback", "failedCallback"], arguments);
    },

    stop: function (successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "stop", [ "successCallback", "failedCallback"], arguments);
    },

    getState: function (successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "getState", [ "successCallback", "failedCallback"], arguments);
    },

    startDiscovery: function (successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "startDiscovery", [ "successCallback", "failedCallback"], arguments);
    },

    stopDiscovery: function (successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "stopDiscovery", [ "successCallback", "failedCallback"], arguments);
    },

    connect: function (peripheralId, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "connect", [ "peripheralId", "successCallback", "failedCallback"], arguments);
    },

    disconnect: function (peripheralId, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("btPeripheral", "disconnect", [ "peripheralId", "successCallback", "failedCallback"], arguments);
    }
}

RBCBridge.loadParameters("btPeripheral", ["supported"], function (parameters) {
    if (parameters.btPeripheral != null && parameters.btPeripheral !== undefined)
        btPeripheral.supported = parameters.btPeripheral.supported;
    else
        btPeripheral.supported = false;
});
...
var nfc = {
    ...
    write: function (ndefMessage, errorCallback) {
        return RBCBridge.exec("nfc", "writeTag", {"ndefMessage":ndefMessage}, null, errorCallback);
    },


    share: function (ndefMessage, errorCallback) {
        return RBCBridge.exec("nfc", "shareTag", {"ndefMessage":ndefMessage}, null, errorCallback);
    },


    unshare: function (errorCallback) {
        return RBCBridge.exec("nfc", "unshareTag", null, null, errorCallback);
    },
...
window.googleCast =
{
    ...
    {
        return RBCBridge.execWithArguments("googleCast", "startScanning", ["successCallback", "failedCallback"], arguments);
    },
    ...
    {
        return RBCBridge.execWithArguments("googleCast", "stopScanning", ["successCallback", "failedCallback"], arguments);
    },

    connect: function ( deviceId, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("googleCast", "connect", ["deviceId", "successCallback", "failedCallback"], arguments);
    },

    disconnect: function ( deviceId, successCallback, errorCallback )
    {
        return RBCBridge.execWithArguments("googleCast", "disconnect", ["deviceId", "successCallback", "failedCallback"], arguments);
    },
...
RBCBridge.loadParameters("googleCast", ["supported"], function (parameters) {
    if (parameters.googleCast != null && parameters.googleCast !== undefined)
        googleCast.supported = parameters.googleCast.supported;
    else
        googleCast.supported = false;
});
